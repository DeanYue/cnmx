...
/**
 * The purpose of this file is to add the support of Cnmx actions of type
...
var WKHTMLTOPDF_MESSAGES = {
    ...
    workers: _lt('You need to start Cnmx with at least two workers to print a pdf version of ' +
                 'the reports.'),
};
