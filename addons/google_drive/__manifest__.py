...

{
    ...
    'description': """
Integrate google document to Cnmx record.
============================================

This module allows you to integrate google documents to any of your Cnmx record quickly and easily using OAuth 2.0 for Installed Applications,
