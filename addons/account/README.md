...
The Cnmx <a href="https://www.cnmx.com/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. Cnmx's user interface is designed with productivity in mind.
...
accounting; Cnmx has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

Cnmx supports multiple currencies, multiple users with different access rights,
