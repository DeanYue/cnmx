define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // CNMX: allow access for override
    this.table = table;   // CNMX: allow access for override
    this.typing = typing; // CNMX: allow access for override
    this.bullet = bullet; // CNMX: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // CNMX: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // CNMX: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // CNMX: addition
        $(anchor).css(linkInfo.style || {}); // CNMX: addition
        if (isNewWindow) {
