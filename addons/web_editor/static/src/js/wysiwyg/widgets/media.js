...
/**
 * Let users choose a file, including uploading a new file in cnmx.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" cnmx domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in cnmx.
 */
...
/**
 * Let users choose a document, including uploading a new document in cnmx.
 */
