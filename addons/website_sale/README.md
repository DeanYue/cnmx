...
Cnmx is an <a href="https://www.cnmx.com/page/e-commerce">Open Source eCommerce</a>
...
Cnmx's unique *'edit inline'* and building blocks approach makes product pages
...
Cnmx's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Cnmx's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Cnmx marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Cnmx proposes
...
SEO tools are ready to use, with no configuration required. Cnmx suggests
...
Create new landing pages easily with the Cnmx inline edition feature. Send
...
Benefit from the power of Cnmx, in your online store: a powerfull tax engine,
...
Everything is integrated With Cnmx. No pain, real time.
