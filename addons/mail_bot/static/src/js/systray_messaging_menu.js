...
return MessagingMenu.include({
     ...
     * messaging menu (e.g. 'CnmxBot has a request')
     *
     * @override
     * @private
     ...
     * CnmxBot, and the CnmxBot influences the counter by 1 when it requests
    ...
    /**
     * Override so that it handles preview related to CnmxBot
     *
     * @override
     * @private
     * @param {MouseEvent} ev
